  ...
  return (
    <div className="xs:grid-cols-2 grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4">
      ...
      <Product
        ...
        productImgLink={
          "https://www.startech.com.bd/image/cache/catalog/laptop/apple/macbook-air-13-m4/midnight/macbook-air-13-m4-midnight-01-500x500.webp"
        }
        price={"142,500"}
      />
      <Product
        id={3}
        productName={'iPad Pro M5 13" (2025)'}
        productImgLink={
          "https://ddfndelma2gpn.cloudfront.net/color/2811/iPad_Pro_M5_-_Space_Black.webp"
        }
        price={"174,999"}
      />
      <Product
